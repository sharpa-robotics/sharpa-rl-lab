...
## deploy
```bash
python rl_isaaclab/scripts/gym_style/deploy.py --task Isaac-Inhand-Rotate-Deploy-Sharpa-Wave-v0 --load_path output
```

# make prim uninstanceable
```bash
python tools/make_uninstanceable.py --usd_file usd_file --prim_path prim_path
```